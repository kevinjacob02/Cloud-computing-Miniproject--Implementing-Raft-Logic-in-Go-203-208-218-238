...
func (this *RaftNode) startElection() {
	...
	this.currentTerm += 1 //Increments the currentTerm of the Raft node. This is the term number of the current election and is used to prevent stale leaders from taking over.
